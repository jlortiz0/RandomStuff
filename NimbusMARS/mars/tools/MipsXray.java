...
public class MipsXray extends AbstractMarsToolAndApplication {
    ...
    protected JComponent getHelpComponent() {
        final String helpContent
            ...
            + "Version 2.0\n"
            + "Developed by Marcio Roberto, Guilherme Sales, Fabricio Vivas, Flavio Cardeal and Fabio Locio\n"
...
//	 private Vertex[][] inputGraph;
        ...
        public void actionPerformed(ActionEvent e) // triggered by the timer: update, repaint
        {
            if (justStarted) {
                justStarted = false;
            }
