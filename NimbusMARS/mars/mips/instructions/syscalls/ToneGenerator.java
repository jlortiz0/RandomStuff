...
class ToneGenerator {
     ...
     * @param instrument the desired instrument (or patch) represented by a
     * positive byte value (0-127). See the <a href=
     * http://www.midi.org/about-midi/gm/gm1sound.shtml#instrument>general MIDI
     * instrument patch map</a> for more instruments associated with each value.
...
class Tone implements Runnable {
     ...
     * of the initial attack of the note (MIDI velocity). 127 being loud, and 0
     * being silent.
     */
