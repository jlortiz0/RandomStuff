...
public class ProgramStatement {
     ...
     *
     * @param sourceMIPSprogram The MIPSprogram object that contains this
     * statement
     ...
     * values).
     *
     * @param errors The list of assembly errors encountered so far. May add to
     * it here.
     *
     */
    public void buildBasicStatementFromBasicInstruction(ErrorList errors) {
        ...
        for (int i = 1; i < strippedTokenList.size(); i++) {
            ...
            if (tokenType == TokenTypes.REGISTER_NUMBER) {
                 ...
                 * 0xffff8000 ... 0xffffffff } } ************************* END
                 * DPS 3-July-2008 COMMENTS ******************************
                 */
                basic += tempNumeric;
    ...
    public String toString() {
        ...
        if (operands != null) {
            for (int i = 0; i < this.numOperands; i++) // result += operands[i] + " ";
            {
