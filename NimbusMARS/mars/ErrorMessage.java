...
public class ErrorMessage {
    ...
    *
     ...
     * Normally is starting position of source token.
     * @param message String containing appropriate error message.
     * @param macroExpansionHistory provided so message for macro can include
     * both definition and usage line numbers
     * @deprecated Newer constructors replace the String filename parameter with
     * a MIPSprogram parameter to provide more information.
    *
     */
    ...
    *
     ...
     *
     * @param statement The ProgramStatement object for the instruction causing
     * the runtime error
     * @param message String containing appropriate error message.
    *
     */
