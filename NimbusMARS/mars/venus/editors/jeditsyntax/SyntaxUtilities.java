...
public class SyntaxUtilities {
    ...
    public static SyntaxStyle[] getDefaultSyntaxStyles() {
        ...
        styles[Token.COMMENT1] = new SyntaxStyle(new Color(0x428bdd), true, false);//(Color.black,true,false);
        styles[Token.COMMENT2] = new SyntaxStyle(new Color(0x428bdd), true, false);
        styles[Token.KEYWORD1] = new SyntaxStyle(new Color(248, 187, 0), false, false);//(Color.black,false,true);
        styles[Token.KEYWORD2] = new SyntaxStyle(Color.magenta, false, false);
        styles[Token.KEYWORD3] = new SyntaxStyle(new Color(9, 138, 24), false, false);//(new Color(0x009600),false,false);
        styles[Token.LITERAL1] = new SyntaxStyle(new Color(226, 206, 0), false, false);//(new Color(0x650099),false,false);
        styles[Token.LITERAL2] = new SyntaxStyle(new Color(226, 206, 0), false, false);//(new Color(0x650099),false,true);
        styles[Token.LABEL] = new SyntaxStyle(new Color(0xe6e6e6), true, false);//(new Color(0x990033),false,true);
        styles[Token.OPERATOR] = new SyntaxStyle(new Color(0xe6e6e6), false, true);
        styles[Token.INVALID] = new SyntaxStyle(Color.red, false, false);
        styles[Token.MACRO_ARG] = new SyntaxStyle(new Color(0x8A86C1), false, false);
        return styles;
    }
