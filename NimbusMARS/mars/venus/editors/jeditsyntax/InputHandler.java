...
public abstract class InputHandler extends KeyAdapter {
    ...
    public static class end implements ActionListener {
        ...
        public void actionPerformed(ActionEvent evt) {
            ...
            int caret = textArea.getLineEndOffset(
    ...
    public static class home implements ActionListener {
        ...
        public void actionPerformed(ActionEvent evt) {
            ...
            int caret = textArea.getCaretPosition();
            int lineOffset = textArea.getLineStartOffset(textArea.getCaretLine());
            int firstOfLine = textArea.getLeadingWhiteSpace().length() + lineOffset;
    ...
    public static class insert_tab implements ActionListener {
        ...
        public void actionPerformed(ActionEvent evt) {
            ...
            if (textArea.getSelectedText() != null) {
                String output = new String(new char[textArea.painter.tabSizeChars]).replace('\0', ' ');
                for (int i = textArea.getSelectionStartLine(); i <= textArea.getSelectionEndLine(); i++) {
                    try {
                        textArea.getDocument().insertString(textArea.getLineStartOffset(i), output, null);
            ...
            length -= textArea.getLineStartOffset(textArea.getCaretLine());
            length %= textArea.painter.tabSizeChars;
            String output = new String(new char[textArea.painter.tabSizeChars - length]);
            textArea.overwriteSetSelectedText(output.replace('\0', ' '));
        }
    }
